...
Dieses Impressum sowie Datenschutzerklärung gelten ebenso für [NoNewMachines.com](https://www.nonewmachines.com/).
...
Zur Zählung der Besuchszahlen - und Zugriffen verwenden wir "[Plausible](https://plausible.io/data-policy)", einen Online-Dienst der keine personen-bezogenen Daten speichert oder verarbeiten kann. Es werden keine besucher-bezogenen oder persönlichen Daten (IP-Adresse, Browser,... ) übermittelt. Alle Daten werden anonymisiert und anschließend bei Bedarf bei Plausible Insights OU und deren beauftragen Webhosting-Anbieter (Digital Ocean) innerhalb der Europäischen Union gespeichert.
